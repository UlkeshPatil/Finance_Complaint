...
class DataIngestion:
    ...
    def convert_files_to_parquet(
        ...
        try:
            ...
            for file_name in os.listdir(json_data_dir):
                ...
                logger.info(
                    f"Converting {json_file_path} into parquet format at {file_path}"
                )
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        try:
            logger.info("Started downloading json file")
            if (
            ...
            if os.path.exists(self.data_ingestion_config.download_dir):
                logger.info(
                    "Converting and combining downloaded json into parquet file"
                )
